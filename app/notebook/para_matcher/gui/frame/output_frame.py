...
class OutputFrame(ttk.Frame):
    ...
    def __init__(self, parent, results: dict, *args, **kwargs):
        ...
        self.keys_title = ttk.Label(self, text='Parametro', font=('Elvetica', 16))
        self.keys_title.grid(row=0, column=0, padx=50, pady=25)
        self.title_one = ttk.Label(self, text='Parametro 1', font=('Elvetica', 16))
        self.title_one.grid(row=0, column=1, padx=50, pady=25)
        self.title_two = ttk.Label(self, text='Parametro 2', font=('Elvetica', 16))
